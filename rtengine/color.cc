...
LUTf Color::_4P10, Color::_4P20, Color::_4P30, Color::_4P40, Color::_4P50,
    Color::_4P60;
LUTf Color::_1P10, Color::_1P20, Color::_1P30, Color::_1P40, Color::_1P50,
    Color::_1P60;
LUTf Color::_10PB10, Color::_10PB20, Color::_10PB30, Color::_10PB40,
    Color::_10PB50, Color::_10PB60;
LUTf Color::_9PB10, Color::_9PB20, Color::_9PB30, Color::_9PB40, Color::_9PB50,
    Color::_9PB60, Color::_9PB70, Color::_9PB80;
LUTf Color::_75PB10, Color::_75PB20, Color::_75PB30, Color::_75PB40,
    Color::_75PB50, Color::_75PB60, Color::_75PB70, Color::_75PB80;
LUTf Color::_6PB10, Color::_6PB20, Color::_6PB30, Color::_6PB40, Color::_6PB50,
    Color::_6PB60, Color::_6PB70, Color::_6PB80;
LUTf Color::_45PB10, Color::_45PB20, Color::_45PB30, Color::_45PB40,
    Color::_45PB50, Color::_45PB60, Color::_45PB70, Color::_45PB80;
LUTf Color::_3PB10, Color::_3PB20, Color::_3PB30, Color::_3PB40, Color::_3PB50,
    Color::_3PB60, Color::_3PB70, Color::_3PB80;
LUTf Color::_15PB10, Color::_15PB20, Color::_15PB30, Color::_15PB40,
    Color::_15PB50, Color::_15PB60, Color::_15PB70, Color::_15PB80;
LUTf Color::_05PB40, Color::_05PB50, Color::_05PB60, Color::_05PB70,
    Color::_05PB80;
...
LUTf Color::_10YR20, Color::_10YR30, Color::_10YR40, Color::_10YR50,
    Color::_10YR60, Color::_10YR70, Color::_10YR80, Color::_10YR90;
LUTf Color::_85YR20, Color::_85YR30, Color::_85YR40, Color::_85YR50,
    Color::_85YR60, Color::_85YR70, Color::_85YR80, Color::_85YR90;
LUTf Color::_7YR30, Color::_7YR40, Color::_7YR50, Color::_7YR60, Color::_7YR70,
    Color::_7YR80;
LUTf Color::_55YR30, Color::_55YR40, Color::_55YR50, Color::_55YR60,
    Color::_55YR70, Color::_55YR80, Color::_55YR90;
LUTf Color::_4YR30, Color::_4YR40, Color::_4YR50, Color::_4YR60, Color::_4YR70,
    Color::_4YR80;
LUTf Color::_25YR30, Color::_25YR40, Color::_25YR50, Color::_25YR60,
    Color::_25YR70;
...
LUTf Color::_7G30, Color::_7G40, Color::_7G50, Color::_7G60, Color::_7G70,
    Color::_7G80;
LUTf Color::_5G30, Color::_5G40, Color::_5G50, Color::_5G60, Color::_5G70,
    Color::_5G80;
LUTf Color::_25G30, Color::_25G40, Color::_25G50, Color::_25G60, Color::_25G70,
    Color::_25G80;
LUTf Color::_1G30, Color::_1G40, Color::_1G50, Color::_1G60, Color::_1G70,
    Color::_1G80;
LUTf Color::_10GY30, Color::_10GY40, Color::_10GY50, Color::_10GY60,
    Color::_10GY70, Color::_10GY80;
LUTf Color::_75GY30, Color::_75GY40, Color::_75GY50, Color::_75GY60,
    Color::_75GY70, Color::_75GY80;
LUTf Color::_5GY30, Color::_5GY40, Color::_5GY50, Color::_5GY60, Color::_5GY70,
    Color::_5GY80;
...
void Color::xyz2r(
    ...
    const double rgb_xyz[3][3]) // for black & white we need only r channel
{
    // Transform to output color.  Standard sRGB is D65, but internal
    // representation is D50 Note that it is only at this point that we should
    // have need of clipping color data
...
void Color::interpolateRGBColor(const float balance, const float r1,
                                ...
                                const float g2, const float b2, int toDo,
                                const double xyz_rgb[3][3],
                                const double rgb_xyz[3][3], float &ro,
                                float &go, float &bo)
{
...
void Color::interpolateRGBColor(float realL, float iplow, float iphigh,
                                int algm, const float balance, int twoc,
                                int metchrom, float chromat, float luma,
                                ...
                                float &go, float &bo)
{
    ...
    float L1 = 0.f, L2, LL, a_1 = 0.f, b_1 = 0.f, a_2 = 0.f, b_2 = 0.f, a_L,
          b_L;
    ...
    if (twoc == 0) { // 2 colours
        ...
        if (realL > medH && realL <= iphigh) {
            calH = realL * calan / (iphigh - medH) -
                   medH * calan / (iphigh - medH);
        } else if (realL > iphigh) {
            calH = realL * calan; //*(iphigh-1.f) - calan*(iphigh-1.f);//it is
                                  //better without transition in highlight
        }
    }
                        ...
                        float factor) // standard gamma without slope...
{
    ...
    // first input value is zero => we have to use the xlogf function which
    // checks this
    vfloat resultv = xexpf((xlogf(iv) - divisorv) * gammav) * factorv;
    STVFU(gammacurve[0], resultv);
    iv += fourv;

    // inside the loop we can use xlogfNoCheck and xexpfNoCheck because we know
    ...
    for (int i = 0; i < 65536; ++i) {
        gammacurve[i] =
            Color::gammanf(static_cast<float>(i) / divisor, gamma) * factor;
    }
...
void Color::Yuv2Lab(float Yin, float u, float v, float &L, float &a, float &b,
                    const double wp[3][3])
{
    float u1 = u + u0;
    float v1 = v + v0;
 ...
 *
 * take the plane spanned by X=a*Xr+b*Xg+c*Xb etc with one of a,b,c equal to 0
 * or 1, and itersect with the line u0+lam*u, or in other words solve
 *
 *    u0+lam*u=fu(X,Y,Z)
 *    v0+lam*v=fv(X,Y,Z)
 *
 * The value of lam is the scale factor that takes the color to the gamut
 * boundary columns of the matrix p=xyz_rgb are RGB tristimulus primaries in XYZ
            ...
            lam[c][m] =
                (-(p[0][c1] * p[1][c] *
                 ...
                 p[0][c] * p[1][c1] *
                     ((-12 + 3 * u0 + 20 * v0) * Y +
                      4 * m * 65535 * v0 * p[2][c2]) -
                 4 * v0 * p[0][c1] * (Y - m * 65535 * p[1][c2]) * p[2][c] +
                 4 * v0 * p[0][c] * (Y - m * 65535 * p[1][c2]) * p[2][c1] -
                 (4 * m * 65535 * v0 * p[0][c2] - 9 * u0 * Y) *
                     (p[1][c1] * p[2][c] - p[1][c] * p[2][c1]));

            lam[c][m] /=
                (3 * u * Y *
                     (p[0][c1] * p[1][c] - p[1][c1] * (p[0][c] + 3 * p[2][c]) +
                      3 * p[1][c] * p[2][c1]) +
                 4 * v *
                     (p[0][c1] *
                          (5 * Y * p[1][c] + m * 65535 * p[1][c] * p[2][c2] +
                           Y * p[2][c] - m * 65535 * p[1][c2] * p[2][c]) -
                      p[0][c] *
                          (5 * Y * p[1][c1] + m * 65535 * p[1][c1] * p[2][c2] +
                           Y * p[2][c1] - m * 65535 * p[1][c2] * p[2][c1]) +
                      m * 65535 * p[0][c2] *
                          (p[1][c1] * p[2][c] - p[1][c] * p[2][c1])));
...
void Color::skinred(double J, double h, double sres, double Sp, float dred,
                    float protect_red, int sk, float rstprotection, float ko,
                    double &s)
{
    ...
    // rough correspondence between h (JC) and H (lab) that has relatively
    // little importance because transitions that blur the correspondence is not
    // linear
    ...
    if (doskin) {
        ...
        if (chromapro > 0.0) {
            Color::scalered(rstprotection, chromapro, 0.0, HH, deltaHH, scale,
                            scaleext); // Scale factor
        }
        ...
        factorsat = chromapro;
        factor = factorsat;
        Color::transitred(HH, s, dred, factorskin, protect_red, factorskinext,
                          deltaHH, factorsat, factor); // transition
        s *= factor;
    } else {
        s = ko * sres;
    }
}
void Color::skinredfloat(float J, float h, float sres, float Sp, float dred,
                         float protect_red, int sk, float rstprotection,
                         float ko, float &s)
{
    float HH;
    bool doskin = false;
    ...
    if (doskin) {
        ...
        if (chromapro > 1.0) {
            float scale =
                0.999000999f;      // 100.0f/100.1f; reduction in normal zone
            float scaleext = 1.0f; // reduction in transition zone
            Color::scalered(rstprotection, chromapro, 0.0, HH, deltaHH, scale,
                            scaleext); // Scale factor
...
void Color::scalered(const float rstprotection, const float param,
                     const float limit, const float HH, const float deltaHH,
                     float &scale, float &scaleext)
{
    if (rstprotection < 99.9999f) {
        ...
        // scaleext=HH*(1.0f-scale)/deltaHH + 1.0f -
        // (1.3f+deltaHH)*(1.0f-scale)/deltaHH;    //transition for Hue (red -
        // yellow) optimized formula
        {
            scaleext = (HH * (1.0f - scale) + deltaHH -
                        (1.3f + deltaHH) * (1.0f - scale)) /
                       deltaHH; // transition for Hue (red - yellow)
        } else if ((HH < 0.15f && HH > (0.15f - deltaHH)))
        // scaleext=HH*(scale-1.0f)/deltaHH + 1.0f -
        // (0.15f-deltaHH)*(scale-1.0f)/deltaHH;   //transition for hue (red
        // purple) optimized formula
        {
            scaleext = (HH * (scale - 1.0f) + deltaHH -
                        (0.15f - deltaHH) * (scale - 1.0f)) /
                       deltaHH; // transition for hue (red purple)
        }
    }
}

void Color::transitred(const float HH, float const Chprov1, const float dred,
                       const float factorskin, const float protect_red,
                       const float factorskinext, const float deltaHH,
                       const float factorsat, float &factor)
{
    if (HH >= 0.15f && HH < 1.3f) {
        if (Chprov1 < dred) {
            factor = factorskin;
            ...
            factor =
                ((factorsat - factorskin) * Chprov1 + factorsat * protect_red -
                 (dred + protect_red) * (factorsat - factorskin)) /
                protect_red;
        }
    } else if (HH > (0.15f - deltaHH) &&
               HH < (1.3f +
                     deltaHH)) { // test if chroma is in the extended range
        if (Chprov1 < dred) {
            factor = factorskinext; // C=dred=55 => real max of skin tones
        } else if (Chprov1 < (dred + protect_red)) { // transition
            factor = ((factorsat - factorskinext) * Chprov1 +
                      factorsat * protect_red -
                      (dred + protect_red) * (factorsat - factorskinext)) /
                     protect_red;
        }
    }
}
 ...
 */
#ifdef _DEBUG
void Color::AllMunsellLch(bool lumaMuns, float Lprov1, float Loldd, float HH,
 ...
 */
void Color::AllMunsellLch(float Lprov1, float HH, float Chprov1, float CC,
 ...
 */
#ifdef _DEBUG
void Color::gamutLchonly(float HH, float &Lprov1, float &Chprov1, float &R,
...
#endif
{
    ...
    do {
        ...
        float y_ = (Lprov1 > epskap) ? 65535.0 * fy * fy * fy
                                     : 65535.0 * Lprov1 / kappa;
 ...
 */
#ifdef _DEBUG
void Color::gamutLchonly(float HH, float2 sincosval, float &Lprov1,
...
#endif
{
    ...
    do {
        ...
        float x_ = 65535.0f * f2xyz(fx) * D50x;
        float z_ = 65535.0f * f2xyz(fz) * D50z;
        float y_ = (Lprov1 > epskap) ? 65535.0f * fy * fy * fy
                                     : 65535.0f * Lprov1 / kappa;
...
#ifdef _DEBUG
void Color::gamutLchonly(float2 sincosval, float &Lprov1, float &Chprov1,
                         const float wip[3][3], const bool isHLEnabled,
                         const float lowerCoef, const float higherCoef,
                         bool &neg, bool &more_rgb)
#else
 ...
 */
void Color::LabGamutMunsell(float *labL, float *laba, float *labb, const int N,
 ...
 */
void Color::MunsellLch(float lum, float hue, float chrom, float memChprov,
 ...
 * Copyright (c)2011  Jacques Desmis <jdesmis@gmail.com>
 *
 * skin color: mixed from NX2 skin color palette, Von Luschan, and photos of
 * people white, black, yellow....there are some little exceptions...cover 99%
 * case pay attention to white balance, and do not change hue and saturation,
 * upstream of the modification
 *
 */
void Color::SkinSat(float lum, float hue, float chrom, float &satreduc)
{
    ...
    constexpr float reduction =
        0.3f; // use "reduction" for  "real" skin color : take into account a
              // slightly usage of contrast and saturation in RT if option
              // "skin" = 1
    constexpr float extendedreduction =
        0.4f; // use "extendedreduction" for wide area skin color, useful if not
              // accurate colorimetry or if the user has changed hue and
              // saturation
    constexpr float extendedreduction2 =
        0.6f; // use "extendedreduction2" for wide area for transition

    constexpr float C9 = 8.f, C8 = 15.f, C7 = 12.f, C4 = 7.f, C3 = 5.f,
                    C2 = 5.f, C1 = 5.f;
    constexpr float H9 = 0.05f, H8 = 0.25f, H7 = 0.1f, H4 = 0.02f, H3 = 0.02f,
                    H2 = 0.1f, H1 = 0.1f, H10 = -0.2f,
                    H11 = -0.2f; // H10 and H11 are curious...H11=-0.8 ??

    if (lum >= 85.f) {
        if ((hue > (0.78f - H9) && hue < (1.18f + H9)) &&
            (chrom > 8.f && chrom < (14.f + C9))) {
            satreduc = reduction;
        } else if (lum >= 92.f) {
            if ((hue > 0.8f && hue < 1.65f) &&
                (chrom > 7.f && chrom < (15.f))) {
                satreduc = extendedreduction;
            } else if ((hue > -0.1f && hue < 1.65f) &&
                       (chrom > 7.f && chrom < (18.f))) {
                satreduc = extendedreduction2;
            }
        } else if ((hue > 0.7f && hue < 1.4f) &&
                   (chrom > 7.f && chrom < (26.f + C9))) {
            satreduc = extendedreduction;
        } else if (lum < 92.f && (hue > 0.f && hue < 1.65f) &&
                   (chrom > 7.f && chrom < (35.f + C9))) {
            satreduc = extendedreduction2;
        }
    } else if (lum >= 70.f) {
        if ((hue > 0.4f && hue < (1.04f + H8)) &&
            (chrom > 8.f && chrom < (35.f + C8))) {
            satreduc = reduction;
        } else if ((hue > (0.02f + H11) && hue < 1.5f) &&
                   (chrom > 7.0f && chrom < (48.f + C9))) {
            satreduc = extendedreduction;
        } else if ((hue > (0.02f + H11) && hue < 1.65f) &&
                   (chrom > 7.f && chrom < (55.f + C9))) {
            satreduc = extendedreduction2;
        }
    } else if (lum >= 52.f) {
        if ((hue > 0.3f && hue < (1.27f + H7)) &&
            (chrom > 11.f && chrom < (35.f + C7))) {
            satreduc = reduction;
        } else if ((hue > (0.02f + H11) && hue < 1.5f) &&
                   (chrom > 7.0f && chrom < (48.f + C9))) {
            satreduc = extendedreduction;
        ...
        if ((hue > 0.3f && hue < (1.25f + H4)) &&
            (chrom > 13.f && chrom < (37.f + C4))) {
            satreduc = reduction;
        } else if ((hue > (0.02f + H11) && hue < 1.5f) &&
                   (chrom > 7.0f && chrom < (48.f + C9))) {
            satreduc = extendedreduction;
        ...
        if ((hue > 0.3f && hue < (1.2f + H3)) &&
            (chrom > 7.f && chrom < (35.f + C3))) {
            satreduc = reduction;
        } else if ((hue > (0.02f + H11) && hue < 1.5f) &&
                   (chrom > 7.0f && chrom < (48.f + C9))) {
            satreduc = extendedreduction;
        ...
        if ((hue > (0.f + H10) && hue < (0.95f + H2)) &&
            (chrom > 8.f && chrom < (23.f + C2))) {
            satreduc = reduction;
        } else if ((hue > (0.02f + H11) && hue < 1.f) &&
                   (chrom > 7.f && chrom < (35.f + C1))) {
            satreduc = extendedreduction;
        } else if ((hue > (0.02f + H11) && hue < 1.6f) &&
                   (chrom > 7.f && chrom < (45.f + C1))) {
            satreduc = extendedreduction2;
        }
    } else {
        if ((hue > (0.02f + H10) && hue < (0.9f + H1)) &&
            (chrom > 8.f && chrom < (23.f + C1))) {
...
void Color::xyz2oklab(float X, float Y, float Z, float &L, float &a, float &b)
{
    ...
    constexpr float M1[3][3] = {{0.8189330101f, 0.3618667424f, -0.1288597137f},
    ...
    constexpr float M2[3][3] = {{0.2104542553f, 0.7936177850f, -0.0040720468f},
...
{
    constexpr float M2_inv[3][3] = {{1.f, 0.39633779f, 0.21580376f},
    ...
    constexpr float M1_inv[3][3] = {{1.22701385f, -0.55779998f, 0.28125615f},
